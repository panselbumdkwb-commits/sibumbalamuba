...
const MENU: MenuItem[] = [
  ...
  },
  {
    ...
    roles: ["admin_bumd", "admin_bpsda", "eksekutif"],
    icon: "🎯",
    color: "bg-primary-50 text-primary-700",
    group: "Data BUMD",
  },
  ...
  },
  {
    ...
    roles: ["admin_blud", "admin_bpsda", "eksekutif"],
    icon: "🎯",
    color: "bg-cyan-50 text-cyan-700",
    group: "Data BLUD",
  },
  ...
  // ------------------------------------------------------- Data Seleksi
  {
    ...
    roles: ["panitia_seleksi", "ketua_pansel", "eksekutif"],
    icon: "🗂️",
  ...
  },
  {
    ...
    roles: ["panitia_seleksi", "ketua_pansel"],
    icon: "📋",
    color: "bg-brand-50 text-brand-700",
    group: "Data Seleksi",
  },
  ...
  {
    href: "/internal/publikasi-monev",
    label: "Publikasi Hasil Monev",
    description: "Kontrol tahun evaluasi mana yang tampil ke dashboard publik.",
    roles: ["admin_bpsda"],
    icon: "📢",
    color: "bg-violet-50 text-violet-700",
    group: "Laporan & Pengawasan",
