...
export default function CreateSuratForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setForm({ judul: "", jenisNaskah: "surat_biasa", sifat: "biasa", lampiran: "-", kepada: "", isiSurat: "", tembusan: "", entitasSeleksi: "" });
    setOpen(false);
    router.refresh();
  }
    ...
    <form onSubmit={handleSubmit} className="card p-5 flex flex-col gap-4">
      ...
      <div>
        ...
        <p className="text-xs text-slate-400 mt-1">
          Menentukan kop surat resmi yang dipakai saat Cetak/Unduh — Perumdam dan PT. BWR punya kop berbeda.
        </p>
      </div>
