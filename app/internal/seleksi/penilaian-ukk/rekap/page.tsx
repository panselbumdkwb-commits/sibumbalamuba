...
export default async function RekapUkkPage({
  ...
  if (!["tim_ukk", "panitia_seleksi", "ketua_pansel", "eksekutif", "super_admin"].includes(profile.role)) {
  ...
  const bisaBuatBeritaAcara = ["tim_ukk", "panitia_seleksi", "ketua_pansel"].includes(profile.role);
