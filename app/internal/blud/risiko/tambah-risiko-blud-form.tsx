...
import { tambahRisikoBlud } from "@/actions/monev-blud.actions";
...
export default function TambahRisikoBludForm({ bludId, tahun }: { bludId: string; tahun: number }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null);
    setLoading(true);
    const result = await tambahRisikoBlud({
      bludId,
      tahun,
    ...
    setForm({ kategori: "pelayanan", deskripsi: "", tingkat: "sedang", mitigasi: "" });
    setOpen(false);
    router.refresh();
  }
